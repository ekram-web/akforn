...
// --- MAIN SERVICES PAGE COMPONENT (FINAL INTEGRATED VERSION) ---
const Services = () => {
  // --- STATE MANAGEMENT ---
    ...
    const fetchData = async () => {
      try {
        const [pageRes, cardsRes, testimonialsRes] = await Promise.all([
          apiClient.get("/services-page-data"),
          apiClient.get("/service-cards"),
    ...
    <div className={styles.servicesPage}>
      ...
      <section className={styles.pageHeader}>
        <div className="container">
          <div className={styles.headerContent}>
            <div className={styles.headerText}>
              <h1 className={styles.pageTitle}>{pageData.header?.title}</h1>
              <p className={styles.pageSubtitle}>{pageData.header?.subtitle}</p>
            </div>
            <div className={styles.headerImageContainer}>
              <img
                src={`${storageUrl}/${pageData.header?.imageUrl}`}
                alt="Professional Services"
                className={styles.headerImage}
              />
            </div>
      ...
      {/* 2. Products Section with ANIMATION (Dynamic) */}
      <section className={styles.productsSection}>
        <div className="container">
          <AnimateOnScroll>
            <h2 className={styles.sectionTitle}>Products We Sell & Install</h2>
          ...
          <div className={styles.productsGrid}>
            {serviceCards.map((product, index) => (
      ...
      {/* 3. Testimonials Section with ANIMATION (Dynamic) */}
      <section className={styles.testimonialsSection}>
        <div className="container">
          <AnimateOnScroll>
            <h2 className={`${styles.sectionTitle} ${styles.lightText}`}>
                ...
                >
                  ...
                  <div className={styles.author}>
                    {testimonial.logo_url && (
                      <img
                        src={`${storageUrl}/${testimonial.logo_url}`}
                        alt={testimonial.company}
                        className={styles.companyLogo}
                      />
                    )}
      ...
      {/* 4. Installation Section with ANIMATION (Dynamic) */}
      <section className={styles.installationSection}>
        <div className="container">
          <AnimateOnScroll>
            <div className={styles.installationContent}>
              ...
              <h2 className={styles.sectionTitle}>
                {pageData.installation?.title}
              </h2>
              <p className={styles.installationDescription}>
                {pageData.installation?.description}
              </p>
            </div>
          </AnimateOnScroll>
        </div>
      ...
      {/* 5. Service Process Section with ANIMATION (Dynamic) */}
      <section className={styles.processSection}>
        <div className="container">
          <AnimateOnScroll>
            <h2 className={styles.sectionTitle}>Our Service Process</h2>
          ...
          <div className={styles.processSteps}>
            {[
              { step: 1, title: pageData.process?.step1 },
              { step: 2, title: pageData.process?.step2 },
              { step: 3, title: pageData.process?.step3 },
              { step: 4, title: pageData.process?.step4 },
            ].map((step, index) => (
              <React.Fragment key={step.step}>
                <AnimateOnScroll
                  className={styles.processStepWrapper}
